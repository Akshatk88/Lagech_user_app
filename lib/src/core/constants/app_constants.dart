...
/// Central App Constants for LAGECH User Application.
class AppConstants {
  const AppConstants._();

  static const String title = 'LAGECH';
  static const String appName = 'LAGECH';
  ...
  static const String brandName = 'LAGECH';
