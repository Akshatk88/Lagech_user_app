...
class _LoginScreenState extends ConsumerState<LoginScreen>
  ...
  Widget _buildPage() {
    ...
    // Background image white hai, isliye Welcome black hi rahega.
    final Color primaryTextColor = const Color(0xFF111111);

    // Dark mode mein subtitle black.
  ...
  Widget _buildPhoneField({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isDark ? const Color(0xFF444444) : const Color(0xFFE2E2E2),
        ...
        children: [
          ...
          Expanded(
            child: TextField(
              ...
              cursorColor: const Color(0xFFD71920),
        ...
        child: DecoratedBox(
          decoration: BoxDecoration(
            ...
            gradient: const LinearGradient(
              ...
              colors: [Color(0xFFFF1717), Color(0xFFE50910)],
            ),

            boxShadow: const [
              BoxShadow(
                color: Color(0x45D71920),
          ...
          child: ElevatedButton(
            // --------------------------------------------------
            // IMPORTANT:
            // Button only disabled while OTP is being requested.
            // Dark mode has no effect on this.
            // --------------------------------------------------
