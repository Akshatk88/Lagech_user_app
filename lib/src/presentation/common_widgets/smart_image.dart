...
class SmartImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final resolvedUrl = (raw.startsWith('http://') || raw.startsWith('https://'))
        ? raw
        : (raw.startsWith('/uploads') || raw.startsWith('uploads') || raw.contains('/uploads/'))
            ? ApiConfig.resolveMedia(raw)
            : raw;
    ...
    if (resolvedUrl.startsWith('http')) {
      return CachedNetworkImage(
        ...
        placeholder: (context, _) => _skeleton(context),
  ...
  /// A magenta→teal wash means a missing photo still looks like LAGECH.
