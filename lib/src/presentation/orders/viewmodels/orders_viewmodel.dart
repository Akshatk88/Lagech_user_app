...
class OrdersViewModel extends Notifier<OrdersState> {
  ...
  /// Immediately optimistic/eagerly display a freshly placed order in the list.
  void prependOrderDirectly(OrderModel newOrder) {
    final existingIndex = state.orders.indexWhere((o) => o.id == newOrder.id);
    if (existingIndex >= 0) {
