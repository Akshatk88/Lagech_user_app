...
class _WalletScreenState extends ConsumerState<WalletScreen> {
  ...
  // ponytail: bounds hardcoded here; move to remote config if finance wants to
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: '100',
                      helperText: 'Between ₹${_minTopUp.toInt()} and ₹${_maxTopUp.toInt()}',
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: selectedAmount < _minTopUp || selectedAmount > _maxTopUp
                          ? null
                          : () async {
                              Haptics.success();
