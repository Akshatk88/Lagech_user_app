...
class DeepLinkService {
  ...
  static const String playStoreUrl =
      'https://play.google.com/store/apps/details?id=com.lagech.user';
  ...
  static String generateProductShareText({
    ...
    final prefix = (restaurantName != null && restaurantName.isNotEmpty)
        ? 'Check out "$productName" from $restaurantName on LAGECH!'
        : 'Check out "$productName" on LAGECH!';
    return '$prefix\n\nOrder now on LAGECH:\n$link';
  }
  ...
  static String generateRestaurantShareText({
    ...
    final descriptor = (cuisines != null && cuisines.isNotEmpty)
        ...
        : restaurantName;
    return 'Check out $descriptor on LAGECH!\n\nOrder now on LAGECH:\n$link';
  }
